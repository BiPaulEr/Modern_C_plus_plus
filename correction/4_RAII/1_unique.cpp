...
void test_unique_ptr() {
    ...
    std::unique_ptr<Ressource> ptr1 = std::make_unique<Ressource>(10);
    ptr1->afficher();
...
void test_move_semantics() {
    ...
    std::unique_ptr<Ressource> ptr1 = std::make_unique<Ressource>(20);

    // Transferer la propriete de ptr1 vers ptr3
    std::unique_ptr<Ressource> ptr3 = std::move(ptr1);
    if (!ptr1) {
